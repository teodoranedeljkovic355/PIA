...
router.route('/login').post((req, res)=>{
    ...
    user.findOne({'username': username, 'password':password, 'typeOf':typeOf}, (err, user)=>{
        if(err){
            console.log(err);
        }
        else
   ...
   router.route('/getSubjectByCode').post((req, res)=>{
        ...
        subject.findOne({"subjectCode":subjectCode}, (err, subject)=>{
            if(err){
                console.log(err);
            }else{
                res.json(subject);
    ...
    router.route('/getSubjectByName').post((req, res)=>{
        ...
        subject.findOne({"name":name, "subjectCode": {$ne: subjectCode}},(err, subject)=>{
            if(err){
                console.log(err);
            }else{
                res.json(subject);
    ...
    router.route('/getpass').post((req,res)=>{
        ...
        user.findOne({"username":kor_ime},(err,ob)=>{
            if(ob){
    ...
    router.route('/change').post((req,res)=>{
        ...
        user.collection.updateOne({'username':username},{$set: {"numOfLogin": 1}});
        
        res.json({'por':'ok'});
    });

    router.route('/getAllStaff').get((req,res)=>{
        user.find({employeeFlag : 1},(err,users)=>{
            if(err){
                console.log(err);
            }else{
                res.json(users);
    ...
    router.route('/getAllStudents').get((req,res)=>{
        user.find({employeeFlag : 0},(err,users)=>{
            if(err){
                console.log(err);
            }else{
                res.json(users);
...
router.route('/get1SemesterSub').get((req,res)=>{
    subject.find({master:0, semester : 1, department: "RTI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get2SemesterSub').get((req,res)=>{
    subject.find({master:0, semester : 2, department: "RTI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get3SemesterSub').get((req,res)=>{
    subject.find({master:0, semester : 3, department: "RTI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get4SemesterSub').get((req,res)=>{
    subject.find({master:0, semester : 4, department: "RTI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get5SemesterSub').get((req,res)=>{
    subject.find({master:0, semester : 5, department: "RTI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get6SemesterSub').get((req,res)=>{
    subject.find({master:0, semester : 6, department: "RTI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get7SemesterSub').get((req,res)=>{
    subject.find({master:0, semester : 7, department: "RTI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get8SemesterSub').get((req,res)=>{
    subject.find({master:0, semester : 8, department: "RTI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get1SemesterSi').get((req,res)=>{
    subject.find({master:0, semester : 1, department: "SI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get2SemesterSi').get((req,res)=>{
    subject.find({master:0, semester : 2, department: "SI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get3SemesterSi').get((req,res)=>{
    subject.find({master:0, semester : 3, department: "SI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get4SemesterSi').get((req,res)=>{
    subject.find({master:0, semester : 4, department: "SI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get5SemesterSi').get((req,res)=>{
    subject.find({master:0, semester : 5, department: "SI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get6SemesterSi').get((req,res)=>{
    subject.find({master:0, semester : 6, department: "SI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get7SemesterSi').get((req,res)=>{
    subject.find({master:0, semester : 7, department: "SI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get8SemesterSi').get((req,res)=>{
    subject.find({master:0, semester : 8, department: "SI"},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get1SemesterElse').get((req,res)=>{
    subject.find({master:0, semester : 1, department: {$nin : ["SI", "RTI"]}},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get2SemesterElse').get((req,res)=>{
    subject.find({master:0, semester : 2, department: {$nin : ["SI", "RTI"]}},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get3SemesterElse').get((req,res)=>{
    subject.find({master:0, semester : 3, department: {$nin : ["SI", "RTI"]}},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get4SemesterElse').get((req,res)=>{
    subject.find({master:0, semester : 4, department: {$nin : ["SI", "RTI"]}},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get5SemesterElse').get((req,res)=>{
    subject.find({master:0, semester : 5, department: {$nin : ["SI", "RTI"]}},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get6SemesterElse').get((req,res)=>{
    subject.find({master:0, semester : 6, department: {$nin : ["SI", "RTI"]}},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get7SemesterElse').get((req,res)=>{
    subject.find({master:0, semester : 7, department: {$nin : ["SI", "RTI"]}},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/get8SemesterElse').get((req,res)=>{
    subject.find({master:0, semester : 8, department: {$nin : ["SI", "RTI"]}},(err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/getMaster').get((req,res)=>{
    subject.find({master:1},null, {sort: {'semester' : 'asc'}}, (err, subjects)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subjects);
...
router.route('/getSubjectInfo').post((req, res)=>{
    let name = req.body.name;
    subject.findOne({"name":name},(err, subject)=>{
        if(err){
            console.log(err);
        }else{
            res.json(subject);
...
router.route('/findThoseFromLastWeek').get((req,res)=>{
    ...
    notification.find({"date":{$gte:lastWeek}},(err, notifications)=>{
...
router.route('/getNotifications/:name').get((req, res)=>{
    ...
    console.log(name)
    notification.find({"subjects": name}, null, {sort:{'date': 'desc'}}, (err, notifications)=>{
        if(err){
            console.log(err);
        }
        else
...
router.route('/changeFile').post((req, res)=>{
    ...
    notification.collection.updateOne({"title":title},{$set: {"picture":newPicture}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changeText').post((req, res)=>{
    ...
    notification.collection.updateOne({"title":title},{$set: {"text":newText}});
    res.json({'poruka': 'OK'});
});
...
router.route('/addStudentToSubjects').post((req, res)=>{
    ...
    user.collection.updateOne({"username":chosenStudent},{$set: {"subjects":chosenSubjects}});
    res.json({'poruka': 'OK'});
})
...
router.route('/changeSubjects').post((req, res)=>{
    ...
    notification.collection.updateOne({"title":title},{$set: {"subjects":newSubjects}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changeTitle').post((req, res)=>{
    ...
    notification.collection.updateOne({"title":title},{$set: {"title":newTitle}});
    res.json({'poruka': 'OK'});
...
router.route('/findNewsUpdated').post((req, res)=>{
    ...
    notification.findOne({'title': title}, (err, news)=>{
        if(err){
            console.log(err);
        }
        else
...
router.route('/updateInfo').post((req, res)=>{
    ...
    user.collection.updateOne({'username':username},{$set: {"adress":newAdress}});
    res.json({'poruka': 'OK'});
...
router.route('/updateMobile').post((req, res)=>{
    ...
    user.collection.updateOne({'username':username},{$set: {"mobilePhone":newMobile}});
    res.json({'poruka': 'OK'});
...
router.route('/updatePersonalData').post((req, res)=>{
    ...
    user.collection.updateOne({'username':username},{$set: {"personalData":newPersonalData}});
    res.json({'poruka': 'OK'});
...
router.route('/updateRoomNumber').post((req, res)=>{
    ...
    user.collection.updateOne({'username':username},{$set: {"roomNumber":newRoomNumber}});
    res.json({'poruka': 'OK'});
})
...
router.route('/addNewsWithMoreFiles').post((req,res)=>{
    ...
    notification.collection.updateOne({"title":title},{$push:{"picture":restFiles}});
...
router.route('/getNewsBySubjectName/:nn').get((req, res)=>{
    ...
    notification.find({"subjects": myName},(err, notifications)=>{
        if(err) console.log(err);
        else{
            console.log(notifications);
            res.json(notifications);
...
router.route('/deleteMyNews').post((req,res)=>{
    ...
    notification.findOneAndRemove({"title":title},(err, poruka)=>{
        if(err){
            console.log(err);
        }else{
            res.json({'poruka':'ok'});
...
router.route('/attachPicturesExcercises').post((req, res)=>{
    ...
    let subjectCode = req.body.subjectCode;
    subject.collection.updateOne({"subjectCode":subjectCode},{$set: {"v":picture}});
    res.json({'poruka':'OK'});
})
...
router.route('/attachPicturesLectures').post((req, res)=>{
    let picture = req.body.picture;
    let subjectCode = req.body.subjectCode;
    subject.collection.updateOne({"subjectCode":subjectCode},{$set: {"p":picture}});
    res.json({'poruka':'OK'});
})
router.route('/attachPicturesExamQ').post((req, res)=>{
    let picture = req.body.picture;
    let subjectCode = req.body.subjectCode;
    subject.collection.updateOne({"subjectCode":subjectCode},{$set: {"eq":picture}});
    res.json({'poruka':'OK'});
})
router.route('/attachPicturesLaboratory').post((req, res)=>{
    let picture = req.body.picture;
    let subjectCode = req.body.subjectCode;
    subject.collection.updateOne({"subjectCode":subjectCode},{$set: {"l":picture}});
    res.json({'poruka':'OK'});
})
...
router.route('/uploadComment').post((req,res)=>{
    ...
    subject.collection.updateOne({"subjectCode":subjectCode},{$set: {"comment":comment}});
    res.json({"poruka":"OK"});
})
...
router.route('/changeUsername').post((req, res)=>{
    ...
    user.collection.updateOne({"username":username},{$set: {"username":newUsername}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changePassword').post((req, res)=>{
    ...
    user.collection.updateOne({"password":password, "username":username},{$set: {"password":newPassword}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changeSurname').post((req, res)=>{
    ...
    user.collection.updateOne({"surname":surname, "username":username},{$set: {"surname":newSurname}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changeName').post((req, res)=>{
    ...
    user.collection.updateOne({"name":name, "username":username},{$set: {"name":newName}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changeAdress').post((req, res)=>{
    ...
    user.collection.updateOne({"adress":adress, "username":username},{$set: {"adress":newAdress}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changeWebsite').post((req, res)=>{
    ...
    user.collection.updateOne({"website":website, "username":username},{$set: {"website":newWebsite}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changeMobile').post((req, res)=>{
    ...
    user.collection.updateOne({"mobilePhone":mobilePhone, "username":username},{$set: {"mobilePhone":newMobile}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changePersonalData').post((req, res)=>{
    ...
    user.collection.updateOne({"personalData":personalData, "username":username},{$set: {"personalData":newPersonalData}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changeProfession').post((req, res)=>{
    ...
    user.collection.updateOne({"profession":profession, "username":username},{$set: {"profession":newProfession}});
    res.json({'poruka': 'OK'});
...
router.route('/changeRoomNumber').post((req, res)=>{
    ...
    user.collection.updateOne({"roomNumber":roomNumber, "username":username},{$set: {"roomNumber":newRoomNumber}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changePicture').post((req, res)=>{
    let username = req.body.username;
    let newPicture = req.body.picture;
    user.collection.updateOne({"username":username},{$set: {"picture":newPicture}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changeSubjectsForProf').post((req, res)=>{
    let username = req.body.username;
    let newSubjects = req.body.newSubjects;
    user.collection.updateOne({"username":username},{$set: {"subjects":newSubjects}});
    res.json({'poruka': 'OK'});
});
...
router.route('/deleteStudent').post((req, res)=>{
    ...
    user.collection.findOneAndDelete({"username":username});
    res.json({'poruka':'ok'});
})
...
router.route('/deleteSubject').post((req, res)=>{
    ...
    subject.collection.findOneAndDelete({"subjectCode":subjectCode});
    res.json({'poruka':'ok'});
})
...
router.route('/changeIndex').post((req, res)=>{
    ...
    let username = req.body.username;
    user.collection.updateOne({"username":username, "index":index},{$set: {"index":newIndexS}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changeStatus').post((req, res)=>{
    ...
    let username = req.body.username;
    user.collection.updateOne({"username":username},{$set: {"status":newStatus}});
    res.json({'poruka': 'OK'});
});
...
router.route('/changeStudiesType').post((req, res)=>{
    ...
    let username = req.body.username;
    user.collection.updateOne({"username":username},{$set: {"studiesType":newStudiesType}});
    res.json({'poruka': 'OK'});
});
...
router.route('/updateSubject').post((req, res)=>{
        ...
        subject.collection.updateOne({"subjectCode":oldSubjectCode},{$set: {"subjectCode":newSubjectCode,"name":newNameOfSubject, "typeOfSubject":newTypeOfSubject, "yearOfStudies":newYearOfStudies,
...
router.route('/updateStudent').post((req, res)=>{
    ...
    user.collection.updateOne({"username":oldUsernameS},{$set: {"username":newUsernameS, "name":newNameS, "surname":newSurnameS, "password":newPasswordS, "index":newIndexS, "studiesType":newStudiesTypeS, "status":newStatusS}});
    res.json({'poruka':1});
...
router.route('/updateEmployee').post((req, res)=>{
    ...
    user.collection.updateOne({"username":oldUsername},{$set: {"username":newUsername,"name":newName, "surname":newSurname, "password":newPassword, "mobilePhone":newMobile, "adress":newAdress, "website":newWebsite, "personalData":newPersonalData, "profession": newProfession,"roomNumber":newRoomNumber, "status":newStatus, "subjects":newSubjects}});
    res.json({'poruka':1});
...
router.route('/changeUserData').post((req,res)=>{
    ...
    user.collection.updateOne({"username":username}, {$set: {"adress":newAdress, "mobilePhone":newMobile, "roomNumber":newRoomNumber, "personalData":newPersonalData}});
    res.json({'poruka':1});
})
...
router.route('/changeNewsData').post((req, res)=>{
    ...
    notification.collection.updateOne({"title":oldTitle}, {$set: {"title":newTitle,"text":newText, "subjects":newSubjects}});
    res.json({'poruka':1});
})
...
router.route('/deleteCategory').post((req,res)=>{
    ...
    category.findOneAndRemove({"typeOf":typeOf},(err, poruka)=>{
        if(err){
            console.log(err);
        }else{
            res.json({'poruka':'ok'});
...
router.route('/updateCategory').post((req, res)=>{
    ...
    category.collection.updateOne({'typeOf':typeOf},{$set: {"typeOf": newCategory}});
...
router.route('/deleteNotice').post((req, res)=>{
    ...
    notice.findOneAndRemove({"typeOf":typeOf, "noticesText":noticesText},(err, poruka)=>{
        if(err){
            console.log(err);
        }else{
            res.json({'poruka':'ok'});
...
router.route('/getUpdatingNotice').post((req, res)=>{
    ...
    notice.findOne({"typeOf":typeOf, "noticesText":noticesText},(err,notice)=>{
        if(err){
            console.log(err);
        }else{
            res.json(notice);
...
router.route('/getAllNotices30Days').get((req,res)=>{
    ...
    notice.find({"date":{$gte: lastMonth}},(err, notices)=>{
        if(err) console.log(err);
        else{
            console.log(notices);
            res.json(notices);
